...
namespace IrcSays.Configuration
{
	public class ColorsElement : ConfigurationElement, INotifyPropertyChanged
	{
		...
		public string OldMarker
		{
			...
			set
			{
				this["oldMarker"] = value;
				OnPropertyChanged("OldMarker");
			}
		}
		...
		public string NoiseActivity
		{
			...
			set
			{
				this["noiseActivity"] = value;
				OnPropertyChanged("NoiseActivity");
			}
		}
		...
		public string ChatActivity
		{
			...
			set
			{
				this["chatActivity"] = value;
				OnPropertyChanged("ChatActivity");
			}
		}
		...
		public string WindowForeground
		{
			...
			set
			{
				this["windowForeground"] = value;
				OnPropertyChanged("WindowForeground");
			}
		}
		...
		public ChatPalette Palette
		{
			get
			{
				...
				var palette = new ChatPalette(converter.ConvertFromString(Default) as SolidColorBrush);

				palette.Add("Default", converter.ConvertFromString(Default) as SolidColorBrush);
				palette.Add("Action", converter.ConvertFromString(Action) as SolidColorBrush);
				palette.Add("Ctcp", converter.ConvertFromString(Ctcp) as SolidColorBrush);
				palette.Add("Info", converter.ConvertFromString(Info) as SolidColorBrush);
				palette.Add("Invite", converter.ConvertFromString(Invite) as SolidColorBrush);
				palette.Add("Join", converter.ConvertFromString(Join) as SolidColorBrush);
				palette.Add("Kick", converter.ConvertFromString(Kick) as SolidColorBrush);
				palette.Add("Mode", converter.ConvertFromString(Mode) as SolidColorBrush);
				palette.Add("Nick", converter.ConvertFromString(Nick) as SolidColorBrush);
				palette.Add("Notice", converter.ConvertFromString(Notice) as SolidColorBrush);
				palette.Add("Own", converter.ConvertFromString(Own) as SolidColorBrush);
				palette.Add("Part", converter.ConvertFromString(Part) as SolidColorBrush);
				palette.Add("Quit", converter.ConvertFromString(Quit) as SolidColorBrush);
				palette.Add("Topic", converter.ConvertFromString(Topic) as SolidColorBrush);
				palette.Add("Error", converter.ConvertFromString(Error) as SolidColorBrush);

				palette.Add("Color0", converter.ConvertFromString(Color0) as SolidColorBrush);
				palette.Add("Color1", converter.ConvertFromString(Color1) as SolidColorBrush);
				palette.Add("Color2", converter.ConvertFromString(Color2) as SolidColorBrush);
				palette.Add("Color3", converter.ConvertFromString(Color3) as SolidColorBrush);
				palette.Add("Color4", converter.ConvertFromString(Color4) as SolidColorBrush);
				palette.Add("Color5", converter.ConvertFromString(Color5) as SolidColorBrush);
				palette.Add("Color6", converter.ConvertFromString(Color6) as SolidColorBrush);
				palette.Add("Color7", converter.ConvertFromString(Color7) as SolidColorBrush);
				palette.Add("Color8", converter.ConvertFromString(Color8) as SolidColorBrush);
				palette.Add("Color9", converter.ConvertFromString(Color9) as SolidColorBrush);
				palette.Add("Color10", converter.ConvertFromString(Color10) as SolidColorBrush);
				palette.Add("Color11", converter.ConvertFromString(Color11) as SolidColorBrush);
				palette.Add("Color12", converter.ConvertFromString(Color12) as SolidColorBrush);
				palette.Add("Color13", converter.ConvertFromString(Color13) as SolidColorBrush);
				palette.Add("Color14", converter.ConvertFromString(Color14) as SolidColorBrush);
				palette.Add("Color15", converter.ConvertFromString(Color15) as SolidColorBrush);
